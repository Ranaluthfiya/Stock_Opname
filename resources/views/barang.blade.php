...
<script src="js/bootstrap.bundle.min.js"></script>
    ...
    @endif
<div class="container">
    <h2 style="text-align: center;" class="text-dark fw-bold text-sm pb-4 mt-4">Data Barang</h2>

    <div class="mb-auto text-sm">  
        <table class="table table-bordered text-dark table-sm" style="text-align: center;" border="1">
        <div class="mb-3">
        <!-- Button trigger modal -->
        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#barangModal">
        ...
        Tambah Data
            ...
            <thead>
                ...
                <tr>
                    ...
                    <td>
                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-primary btn-sm btn_editbarang" data-id="{{ $barang->id }}" data-kode="{{ $barang->barang_code }}" data-nama="{{ $barang->barang_nama }}" data-merk="{{ $barang->barang_merk }}" data-jenis=" {{ $barang->barang_jenis }} " data-tipe=" {{$barang->barang_tipe}}" data-satuan="{{ $barang->barang_satuan }}">
        ...
        <div class="container modal-dialog">
            ...
            @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="merkbarang" name="merkbarang" placeholder="Input Merk Barang">
                </div>
                <div class="mb-3">
                    <label for="jenisbarang" class="form-label text-dark fw-bold">Jenis Barang</label>
                    <input type="text" class="form-control" id="jenisbarang" name="jenisbarang" placeholder="Input Jenis Barang">
                </div>
                <div class="mb-3">
                    <label for="tipebarang" class="form-label text-dark fw-bold">Tipe Barang</label>
                    <input type="text" class="form-control" id="tipebarang" name="tipebarang" placeholder="Input Tipe Barang">
                </div>
                <div class="mb-3">
                ...
                <div class="modal-body">
                    <form action="/barang/edit" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <label for="kodebarang" class="form-label text-dark fw-bold">Kode Barang</label>
                            <input type="text" class="form-control @error('kodebarang') is-invalid @enderror" id="txtkodebarang" name="kodebarang" >
                            @error('kodebarang')
                        ...
                        <div class="mb-3">
                            <label for="namabarang" class="form-label text-dark fw-bold">Nama Barang</label>
                            <input type="text" class="form-control @error('namabarang') is-invalid @enderror" id="txtnamabarang" name="namabarang" placeholder="Input Nama Barang">
                            @error('namabarang')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            <label for="merkbarang" class="form-label text-dark fw-bold">Merk Barang</label>
                            <input type="text" class="form-control @error('merkbarang') is-invalid @enderror" id="txtmerkbarang" name="merkbarang" placeholder="Input Merk Barang">
                            @error('merkbarang')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            <label for="jenisbarang" class="form-label text-dark fw-bold">Jenis Barang</label>
                            <input type="text" class="form-control @error('jenisbarang') is-invalid @enderror" id="txtjenisbarang" name="jenisbarang" placeholder="Input Jenis Barang">
                            @error('jenisbarang')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            <label for="tipebarang" class="form-label text-dark fw-bold">Tipe Barang</label>
                            <input type="text" class="form-control @error('tipebarang') is-invalid @enderror" id="txttipebarang" name="tipebarang" placeholder="Input Tipe Barang">
                            @error('tipebarang')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            <label for="satuan" class="form-label text-dark fw-bold">Satuan</label>
                            <input type="text" class="form-control @error('satuan') is-invalid @enderror" id="txtsatuan" name="satuan" placeholder="Input Satuan Barang">
                            @error('satuan')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
